...
<#-- 构造方法 -->
public ${metaName}(Builder builder) {
<#list properties as prop>
...
action.setLoad(${metaName}::load);
action.setReload(${metaName}::reload);
return action;
}
...
<Integer> getIds() {
    ...
    * @return MetaDataList
    */
    public static Collection<${metaName}> findAll() {
    return DATA.getList();
    }
    ...
    * @return MetaData
    */
    public static ${metaName} get(${idType} id) {
    ...
    * @return MetaDataList
    */
    public static List<${metaName}> filter(Predicate<${metaName}> predicate) {
    ...
    * @return MetaDataList
    */
    public static List<${metaName}> filter(Predicate<${metaName}> predicate, Comparator<${metaName}> comparator) {
    Stream<${metaName}> stream = stream().filter(predicate);
    if (comparator != null) {
    ...
    */
    ...
    //全部数据
    private static volatile Map<${idType}, ${metaName}> MAP;

    private static final String NAME = "${metaName}";
    ...
    * @return metas
    */
    public static Collection<${metaName}> getList() {
    ...
    * @return map
    */
    public static Map<${idType}, ${metaName}> getMap() {
    return MAP;
    }
    ...
    */
    ...
    Map<${idType}, ${metaName}> dataMap = new LinkedHashMap<>();
    try {
    List
    <Builder> metaData = Builder.getBuilders();
        if (metaData == null) {
        ...
        */
        ...
        private ${metaName} build() {
        return new ${metaName}(this);
        }
        ...
        */
        ...
        private static ObjectMapper objectMapper = new
        ...
        */
        public static List
        <Builder> getBuilders() throws IOException {
            //JSON数据
            ...
            //填充实体数据
            JsonContent content = objectMapper.readValue(dataStr, new TypeReference
            <JsonContent>() {});
                return content.data;
                }
